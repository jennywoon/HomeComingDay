        ...
        <StHelpWrap>
          <StDetailWrap>
            <StDetailBody>
              <StBodytop>
                <StBodyimg
                  src={freetalksfind && freetalksfind.userImage}
                  alt=''
                />
                <StBodytxt>
                  <StTxtname onClick={onCilckChaetShow}>
                    {freetalksfind && freetalksfind.username}
                  </StTxtname>
                  <StTxtstudent>
                    {freetalksfind && freetalksfind.departmentName}{' '}
                    <span> {freetalksfind && freetalksfind.admission} </span>
                  </StTxtstudent>
                  {showChaet ? (
                    <StChatWrap
              ...
              <StBodyContent>
                <StContentTitle>
                  {freetalksfind && freetalksfind.title}
                </StContentTitle>
                <StContentBody>
                  {freetalksfind && freetalksfind.content}
                </StContentBody>
                {freetalksfind && freetalksfind.imageList?.length !== 0 ? (
                  <StContentImgBox>
                    ...
                    >
                      {freetalksfind &&
                        freetalksfind.imageList?.map((image) => {
                          return (
              ...
              <StBodyContainer>
                <StBodyCommentBox>
                  {freetalksfind && freetalksfind.commentList?.length === 0 ? (
                    ...
                    <>
                      {freetalksfind &&
                        freetalksfind.commentList?.map((comment) => (
                          <FreeTalkDetailComment
                            key={comment.commentId}
                            comment={comment}
                            freetalksfind={freetalksfind}
                            modalRef={modalRef}
                            data={data}
                          />
                        ))}
