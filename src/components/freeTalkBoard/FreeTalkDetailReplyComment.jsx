  ...
  return (
    <div>
      <StReplyCommentBox id={ids} ref={node}>
        {modalOpen && (
          <FreeTalkReplyCommentDeleteModal
        ...
        <StCommentImgDiv>
          <StCommentImg
            src={childComment && childComment.userImage}
          ></StCommentImg>
        </StCommentImgDiv>
        <StCommentReplytxt>
          {!reviseReplyComment ? (
            <>
              ...
              <StUserInfo>
                {childComment && childComment.admission} ·{' '}
                {childComment && childComment.departmentName}
              </StUserInfo>
              <StReplyContent>
                {childComment && childComment.content}
              </StReplyContent>
              <StReplyTime>
                {childComment && childComment.createdAt}
              </StReplyTime>
            </>
          ) : (
            <StReviseBox>
