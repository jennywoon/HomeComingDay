    ...
    <StPrivacyWrap>
      <StWrap>
        <StModalContainer>
          ...
          제1조(개인정보의 처리 목적)<br />
          <br />
          ( Homecoming Day )('https://www.homecomingdaycare.com/'이하 'Homecoming Day')은(는) 다음의 목적을 위하여 개인정보를 처리합니다.<br />
          처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br />

          1. 홈페이지 회원가입 및 관리<br />

          회원제 서비스 제공에 따른 본인 식별·인증 목적으로 개인정보를 처리합니다.<br />
          ...
          <br />
          ① ( Homecoming Day )은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br />
          ...
          ① ( Homecoming Day ) 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.<br />
          ...
          1. 파기절차<br />
          ( Homecoming Day ) 은(는) 파기 사유가 발생한 개인정보를 선정하고, ( Homecoming Day ) 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.<br />
          ...
          ① 정보주체는 Homecoming Day에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.<br />

          ② 제1항에 따른 권리 행사는Homecoming Day에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 Homecoming Day은(는) 이에 대해 지체 없이 조치하겠습니다.<br />
          ...
          ⑥ Homecoming Day은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.<br />


          <br />
          제6조(개인정보의 안전성 확보조치에 관한 사항)<br />
          <br />
          ( Homecoming Day )은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.<br />
          ...
          ① Homecoming Day 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.<br />
          ...
          직책 :관리자<br />
          직급 :관리자<br />
          연락처 :없음, cjaeks0394@naver.com, 없음<br />
          ...
          담당자 :나청운<br />
          연락처 :없음, cjaeks0394@naver.com, 없음<br />
          ② 정보주체께서는 Homecoming Day 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.<br />
          ...
          ( Homecoming Day )은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.<br />
