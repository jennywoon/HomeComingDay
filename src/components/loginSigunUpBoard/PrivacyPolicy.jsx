  ...
  return (
    <StPrivacyWrap>
      <StWrap>
        <StModalContainer>
          <StContentWrap>
            <StTitle><StLogo/>Homecoming Day</StTitle>
              <br /><br />
              ['https://www.homecomingdaycare.com/' 이하 'Homecoming Day']은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.<br />
              <br />
            ...
            <br />
              [ Homecoming Day ]
              <br /><br />
              ['https://www.homecomingdaycare.com/' 이하 'Homecoming Day']은(는) 다음의 목적을 위하여 개인정보를 처리합니다.
              <br />
              처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br />
              <br />
              1. 홈페이지 회원가입 및 관리<br />

              회원제 서비스 제공에 따른 본인 식별·인증 목적으로 개인정보를 처리합니다.<br /><br />
            ...
            1. 홈페이지 회원가입 및 관리 <br />
            필수항목 : 이메일, 비밀번호, 이름, 학력, 서비스 이용 기록, 접속 로그, 쿠키<br />
            선택항목 : 없음<br />
            ...
            1. 파기절차<br />
            [ Homecoming Day ] 은(는) 파기 사유가 발생한 개인정보를 선정하고, [ Homecoming Day ] 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.<br /><br />
            ...
            <br />
            <StTitle>제5조</StTitle>
            <StSecondTitle>(정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한 사항)</StSecondTitle>
            <br />


            ① 정보주체는 Homecoming Day에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.<br /><br />

            ② 제1항에 따른 권리 행사는Homecoming Day에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 Homecoming Day은(는) 이에 대해 지체 없이 조치하겠습니다.<br /><br />
            ...
            ⑥ Homecoming Day은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.<br /><br />

            <StTitle>제6조</StTitle>
            <StTitle>(개인정보의 안전성 확보조치에 관한 사항)<br /></StTitle>
            <br />
            [ Homecoming Day ]은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.<br /><br />
            ...
            <br />
            <StTitle>제7조</StTitle>
            <StSecondTitle>(개인정보를 자동으로 수집하는 장치의 설치·운영 및 그 거부에 관한 사항)<br /></StSecondTitle>
            <br />

            ① Homecoming Day 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.<br /><br />
            ...
            <br />
            <StTitle>제8조</StTitle>
            <StTitle>(개인정보 보호책임자에 관한 사항)<br /></StTitle>
            <br />
            ① Homecoming Day 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br />
            <br />
            ▶ 개인정보 보호책임자<br />
            성명 : 나청운<br />
            직책 : 관리자<br />
            직급 : 관리자<br />
            연락처 : cjaeks0394@naver.com<br />
            ※ 개인정보 보호 담당부서로 연결됩니다.<br /><br />

            ▶ 개인정보 보호 담당부서<br />
            부서명 : HomecomingDay<br />
            담당자 : 나청운<br />
            연락처 : cjaeks0394@naver.com<br /><br />
            ② 정보주체께서는 Homecoming Day 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.<br /><br />
            Homecoming Day 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br />
            <br />
            <StTitle>제9조</StTitle>
            <StTitle>(개인정보의 열람청구를 접수·처리하는 부서)<br /></StTitle>
            <br />
            정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다.<br />
            [ Homecoming Day ]은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.<br /><br />

            ▶ 개인정보 열람청구 접수·처리 부서<br />
            부서명 : Homecoming Day<br />
            담당자 : 나청운<br />
            연락처 : cjaeks0394@naver.com<br />

            <br />
            <StTitle>제10조</StTitle>
            <StTitle>(정보주체의 권익침해에 대한 구제방법)<br /></StTitle>
            <br />
            ...
            <br />
            <StTitle>제11조</StTitle>
            <StTitle>(개인정보 처리방침 변경)<br /></StTitle>
            <br />
...
const StPrivacyWrap = styled.div`
  position: fixed;
  display: flex;
